...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'configure/list-certification-suite-configurations',
        title: 'List Certification Suite Configurations',
        component: ListRdkCertificationComponent,
      },
      {
        path: 'configure/create-certification-suite-configurations',
        title: 'Create Certification Suite Configurations',
        component: CreateRdkCertificationComponent,
      },
      {
        path: 'configure/edit-certification-suite-configurations',
        title: 'Edit Certification Suite Configurations',
